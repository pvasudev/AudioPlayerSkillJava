...
public class PlaybackSettingsManagerImpl implements PlaybackSettingsManager {
    ...
    public PlaybackSettingsManagerImpl(final SpeechletEventManager speechletEventManager) {
